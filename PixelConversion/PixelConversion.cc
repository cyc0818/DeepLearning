...
int main(int argc, char** argv){
    ...
    double x, y, z;
    TFile* LPMTFile = new TFile("/home/userroot/JUNO_ML/PixelConversion/CD_LPMT.root");
    ...
    /*TFile* SPMTFile = new TFile("/home/userroot/JUNO_ML/PixelConversion/CD_SPMT.root");
